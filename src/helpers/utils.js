...
export const generateUUID = (length = 22, options = { numericOnly: false }) => {
    ...
    let textPattern = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
    let numericOnlyPattern = '0123456789';

    const pattern = options && options.numericOnly ? numericOnlyPattern : textPattern;
